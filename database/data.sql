...
VALUES ((select category_id from equipment_categories where name = 'strength'), 'Hammer Strength Machine',
        4.8);
insert into equipment (category_id, name, met_value)
VALUES ((select category_id from equipment_categories where name = 'strength'), 'Bench Press', 6.3);
insert into equipment (category_id, name, met_value)
VALUES ((select category_id from equipment_categories where name = 'strength'), 'Incline Bench Press', 6.6);
insert into equipment (category_id, name, met_value)
VALUES ((select category_id from equipment_categories where name = 'strength'), 'Pullup Bar', 5.5);
insert into equipment (category_id, name, met_value)
VALUES ((select category_id from equipment_categories where name = 'strength'), 'Preacher Bench', 5.8);
insert into equipment (category_id, name, met_value)
