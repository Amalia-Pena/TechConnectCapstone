...
insert into exercise_class (class_name, class_description, class_start_date, class_end_date)
values ('Cycling', 'This cycling class will be intense cycling that will stress your cycling skills',
