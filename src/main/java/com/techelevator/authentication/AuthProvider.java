...
public interface AuthProvider {
     ...
     */
    void register(String username, String password, String role, String firstName, String lastName, String email, byte[] photoPath, double height, double weight, String description);
